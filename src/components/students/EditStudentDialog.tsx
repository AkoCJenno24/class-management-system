...
export function EditStudentDialog({ student, open, onOpenChange }: EditStudentDialogProps) {
  ...
  useEffect(() => {
    if (student) {
      ...
      setAvatarPreset(student.avatarPreset || null);
      setAvatarColor(student.avatarColor || AVATAR_COLORS[0]);
      setPendingAvatarBlob(null);
      setParentGuardian(student.parentGuardian || '');
  ...
  const handleAvatarFileSelect = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast.success('Avatar photo updated in form.');
    } catch {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // If new custom image file was selected, upload it
      if (pendingAvatarBlob) {
        finalAvatarUrl = await uploadStudentAvatar(user.uid, student.id, pendingAvatarBlob);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl w-full p-6">
        <DialogHeader className="pb-1">
          ...
          <DialogDescription>
            Update student profile, enrollment status, avatar, and contact records.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'basic' | 'contact')}>
            ...
            <TabsContent value="basic" className="space-y-3.5 pt-2 focus-visible:outline-none">
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  {(() => {
                    const resolved = resolveAvatarSource({
                      ...
                      avatarPreset,
                      avatarColor,
                      firstName: firstName || student?.firstName || 'Student',
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-2.5 items-start">
                <div className="sm:col-span-4 space-y-1">
                  <Label htmlFor="edit-student-first-name" className="text-xs font-medium">
                ...
                <div className="sm:col-span-3 space-y-1">
                  <Label htmlFor="edit-student-middle-name" className="text-xs font-medium text-muted-foreground">
                ...
                <div className="sm:col-span-3 space-y-1">
                  <Label htmlFor="edit-student-last-name" className="text-xs font-medium">
                ...
                <div className="sm:col-span-2 space-y-1">
                  <Label htmlFor="edit-student-suffix" className="text-xs font-medium text-muted-foreground">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 items-start">
                <div className="space-y-1">
                  <Label htmlFor="edit-student-dob" className="text-xs font-medium">
                    Date of Birth
                  </Label>
                  <Input
                    id="edit-student-dob"
                ...
                <div className="space-y-1">
                  <Label htmlFor="edit-student-gender" className="text-xs font-medium">
                    Sex / Gender
                  </Label>
                  <Select value={gender} onValueChange={(val) => setGender(val || '')} disabled={isLoading}>
                    <SelectTrigger id="edit-student-gender" className="h-8.5 text-xs w-full shadow-2xs">
                ...
                <div className="space-y-1">
                  <Label htmlFor="edit-student-status" className="text-xs font-medium">
                    Status
                  </Label>
                  <Select
                    value={status}
                    ...
                    disabled={isLoading}
                  >
                    <SelectTrigger id="edit-student-status" className="h-8.5 text-xs w-full shadow-2xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-2.5">
                <div className="sm:col-span-4 space-y-1">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="edit-student-grade-level" className="text-xs font-medium">
                      Grade Level
                    </Label>
                    <Link
                      to="/settings"
                  ...
                  <Select
                    ...
                    disabled={isLoading}
                  >
                    <SelectTrigger id="edit-student-grade-level" className="h-8.5 text-xs w-full shadow-2xs">
                ...
                <div className="sm:col-span-4 space-y-1">
                  <Label htmlFor="edit-student-id" className="text-xs font-medium">
                ...
                <div className="sm:col-span-4 space-y-1">
                  <Label htmlFor="edit-student-address" className="text-xs font-medium">
            ...
            <TabsContent value="contact" className="space-y-3.5 pt-2 focus-visible:outline-none">
              ...
              {/* Parent / Guardian */}
              <div className="space-y-1">
                <Label htmlFor="edit-student-parent-guardian" className="text-xs font-medium">
                  Parent / Guardian Name <span className="text-[10px] text-muted-foreground">(optional)</span>
                </Label>
                <Input
                  id="edit-student-parent-guardian"
              ...
              {/* Email Address */}
              <div className="space-y-1">
                <Label htmlFor="edit-student-email" className="text-xs font-medium">
              ...
              {/* Mobile / Phone Number */}
              <div className="space-y-1">
                <Label htmlFor="edit-student-phone" className="text-xs font-medium">
